...
template <> constexpr inline auto RegisterWindow::qt_create_metaobjectdata<qt_meta_tag_ZN14RegisterWindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "backRequested",
        "",
        "on_getCodeButton_clicked",
        "on_createButton_clicked",
        "on_backButton_clicked",
        "onRegRequestCodeResult",
        "success",
        "code",
        "onRegConfirmResult"
    };
...
void RegisterWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_getCodeButton_clicked(); break;
        case 2: _t->on_createButton_clicked(); break;
        case 3: _t->on_backButton_clicked(); break;
        case 4: _t->onRegRequestCodeResult((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        case 5: _t->onRegConfirmResult((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (RegisterWindow::*)()>(_a, &RegisterWindow::backRequested, 0))
            return;
    }
}
